...
#ifndef AI_SMALL_WORDS_MODEL_H
#define AI_SMALL_WORDS_MODEL_H
#pragma once
...
#define AI_SMALL_WORDS_MODEL_ORIGIN_MODEL_NAME   "wordsmodel"
 ...
 * @ref ai_small_words_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_small_words_model_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_SMALL_WORDS_MODEL_*
 * defines into file @ref small_words_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_small_words_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SMALL_WORDS_MODEL_H */
